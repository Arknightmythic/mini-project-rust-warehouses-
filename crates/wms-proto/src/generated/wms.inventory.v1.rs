...
pub struct StockMovement {
    ...
    pub reference_id: ::core::option::Option<i64>,
...
pub struct ReceiveStockRequest {
    ...
    pub items: ::prost::alloc::vec::Vec<ReceiptItem>,
...
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct GetStockBalanceRequest {
    #[prost(int64, tag = "1")]
    pub warehouse_id: i64,
    #[prost(int64, tag = "2")]
    pub product_id: i64,
...
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ListStockBalancesRequest {
    #[prost(int64, optional, tag = "1")]
    pub warehouse_id: ::core::option::Option<i64>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ListStockBalancesResponse {
    #[prost(message, repeated, tag = "1")]
    pub balances: ::prost::alloc::vec::Vec<StockBalance>,
}
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
pub mod inventory_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn receive_stock(
            &mut self,
            request: impl tonic::IntoRequest<super::ReceiveStockRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ReceiveStockResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("wms.inventory.v1.InventoryService", "ReceiveStock"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_stock_balance(
            &mut self,
            request: impl tonic::IntoRequest<super::GetStockBalanceRequest>,
        ) -> std::result::Result<tonic::Response<super::StockBalance>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/wms.inventory.v1.InventoryService/GetStockBalance",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn list_stock_balances(
            &mut self,
            request: impl tonic::IntoRequest<super::ListStockBalancesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListStockBalancesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/wms.inventory.v1.InventoryService/ListStockBalances",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/wms.inventory.v1.InventoryService/ListStockMovements",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod inventory_service_server {
    ...
    pub trait InventoryService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_stock_balance(
            &self,
            request: tonic::Request<super::GetStockBalanceRequest>,
        ) -> std::result::Result<tonic::Response<super::StockBalance>, tonic::Status>;
        async fn list_stock_balances(
            &self,
            request: tonic::Request<super::ListStockBalancesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListStockBalancesResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/wms.inventory.v1.InventoryService/ReceiveStock" => {
                    ...
                    impl<
                        T: InventoryService,
                    > tonic::server::UnaryService<super::ReceiveStockRequest>
                    for ReceiveStockSvc<T> {
                        type Response = super::ReceiveStockResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as InventoryService>::receive_stock(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let fut = async move {
                        let method = ReceiveStockSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                ...
                "/wms.inventory.v1.InventoryService/GetStockBalance" => {
                    #[allow(non_camel_case_types)]
                    struct GetStockBalanceSvc<T: InventoryService>(pub Arc<T>);
                    impl<
                        T: InventoryService,
                    > tonic::server::UnaryService<super::GetStockBalanceRequest>
                    for GetStockBalanceSvc<T> {
                        type Response = super::StockBalance;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as InventoryService>::get_stock_balance(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetStockBalanceSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/wms.inventory.v1.InventoryService/ListStockBalances" => {
                    #[allow(non_camel_case_types)]
                    struct ListStockBalancesSvc<T: InventoryService>(pub Arc<T>);
                    impl<
                        T: InventoryService,
                    > tonic::server::UnaryService<super::ListStockBalancesRequest>
                    for ListStockBalancesSvc<T> {
                        type Response = super::ListStockBalancesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as InventoryService>::list_stock_balances(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListStockBalancesSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    pub const SERVICE_NAME: &str = "wms.inventory.v1.InventoryService";
